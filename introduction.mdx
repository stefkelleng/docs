...
<CardGroup cols="2">
  <Card title="Messtechnik" icon="palette" href="https://mintlify.com/docs/settings/global">
    Customize your docs to your company's colors and brands
  </Card>
  <Card title="Automation" icon="code" href="https://mintlify.com/docs/api-playground/openapi">
